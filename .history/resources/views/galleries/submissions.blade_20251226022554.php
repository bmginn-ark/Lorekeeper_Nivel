...
@section('gallery-content')
    ...
    <p>이곳은 갤러리 제출물의 로그입니다. 특정 갤러리에 작품을 제출하려면 해당 갤러리로 이동하여 "제출" 버튼을 클릭하세요.</p>
    <p>대기 중인 제출물은 협력자{{ Settings::get('gallery_submissions_require_approval') ? ', 그리고 스태프,' : '' }}의 승인을 받은 후 갤러리에 나타납니다.</p>
