@if ($category)
    ...
    <p>{{ __('You are about to delete the category :name. This is not reversible. If prompts in this category exist, you will not be able to delete this category.', ['name' => '<strong>'.$category->name.'</strong>']) }}</p>
