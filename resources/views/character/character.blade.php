    ...
    <div class="card character-bio">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link active" id="statsTab" data-toggle="tab" href="#stats" role="tab">상태</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="notesTab" data-toggle="tab" href="#notes" role="tab">설명</a>
                </li>
            ...
            @if (Auth::check() && Auth::user()->hasPower('manage_characters'))
                <div class="tab-pane fade" id="settings-{{ $character->slug }}">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::label('is_visible', '공개', ['class' => 'form-check-label ml-3']) !!} {!! add_help('캐릭터를 숨기려면 이 기능을 끄세요. 마스터리스트 관리 권한을 가진 모드(바로 당신입니다!)만 볼 수 있으며, 소유자도 캐릭터의 페이지를 볼 수 없습니다.') !!}
                    </div>
                    ...
                    <hr />
                    <div class="text-right">
                        <a href="#" class="btn btn-outline-danger btn-sm delete-character" data-slug="{{ $character->slug }}">삭제</a>
                    </div>
                </div>
            @endif
        </div>
